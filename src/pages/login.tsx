                    ...
                    <Row>
                        ...
                        <Col lg="6" className="" id="login-auth-section">
                            ...
                            <form onSubmit={handleLogin}>
                                ...
                                <input type="text" placeholder="login" name="login" onChange={event => setEmail(event.target.value)} />
                                ...
                                <div className="password-area">
                                    <input type={isHidePassword ? 'text' : 'password'} placeholder="senha" name="password" onChange={event => setPassword(event.target.value)} />
